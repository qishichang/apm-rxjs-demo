...
export class SupplierService {
  ...
  suppliersWithContactMap$ = of(1, 5, 8)
    .pipe(
      tap((id) => console.log('contactMap source observable', id)),
  ...
  constructor(private http: HttpClient) {
    ...
    this.suppliersWithContactMap$.subscribe(
      item => console.log('contactMap result', item)
    );
